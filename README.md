...
The API data comes in as a dictionary format.  Convert API data from dictionary format into python dataframe and display what does the original dataframe looks like
```
